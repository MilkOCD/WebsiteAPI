...
{
    public abstract class TopfinAPIWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TopfinAPIWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TopfinAPIWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<TopfinAPIDbContext> action)
        {
            using (var context = IocManager.Resolve<TopfinAPIDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<TopfinAPIDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<TopfinAPIDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TopfinAPIDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TopfinAPIDbContext, Task<T>> func)
        {
            T result;
